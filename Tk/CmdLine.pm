package Patch::SREZIC::Tk::CmdLine;

package
    Tk::CmdLine; # -*-Perl-*-
# to avoid Tk::CmdLine from being loaded...
$INC{"Tk/CmdLine.pm"} = $INC{"Patch/SREZIC/Tk/CmdLine.pm"};
...
use vars qw($VERSION);
$VERSION = '3.028'; # $Id: CmdLine.pm,v 1.2 2002/03/04 20:09:04 eserte Exp $
